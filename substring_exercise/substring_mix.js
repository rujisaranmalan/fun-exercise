...
function uniqueSubstrings(str, length) {
    let result = [];
    for (let i = 0; i <= str.length - length; i++) {
...
//// Upgrade Version ////
function uniqueSubstringsUpgraded(str, length) {
...
function reverseBetween(str, a, b) {
...
function longestPalindromeUpgraded(strArr) {
    if (strArr.length === 0)
        return [""];
...
function betweenChars(str, start, end) {
    let final = [];
    let pos = 0;
    while (true) {
...
function replaceEveryN(str, n, replacement) {
    let result = [];
...
function findAllBetween(str, start, end) {
    if (str.length === 0) {
        return [];
    }
    let result = [];
...
function substringFrequencies(str, length) {
    let result = {};
    for (let i = 0; i <= str.length - length; i++) {
...
function groupByFirstLetters(words) {
    // Your code here!
    let trace = new Map();
    for (let word of words) {
...
function groupByLastLetter(words) {
    // Your code here!
    let trace = new Map();
    for (let word of words) {
        let toLower = word.toLowerCase();
...
function groupByVowelCount(words) {
    let map = new Map();
    for (let word of words) {
...
function groupByFirstLastCombo(words) {
    let map = new Map();
    for (let word of words) {
        // Your turn!
...
console.log(groupByFirstLastCombo([
...
function groupByUniqueSortedLetters(words) {
    var _a;
    let map = new Map();
    for (let word of words) {
        // Your turn!
        ...
        (_a = map.get(sorting)) === null || _a === void 0 ? void 0 : _a.push(word);
    }
    return Array.from(map.values());
}
